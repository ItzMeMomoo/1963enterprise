...
const BusinessCatalogSection = ({ onBusinessSelect }) => {
  const businessUnits = [
    ...
    },
    {
      ...
      description: "Contemporary coffee house dengan suasana dan ciri dari gaya premium",
      image: "/namtiga.jpg",
    ...
    },
    {
      ...
      name: "BreadCast",
      category: "KULINER & KAFE",
      description: "Bakery yang menyediakan roti segar setiap harinya dan juga berbagai macam kopi",
      image: "/breadcast.jpg",
      tags: ["Bakery", "Roti", "Kopi"],
      buttonColor: "orange",
      location: "Kampus IPB",
      hours: "06:00-20:00",
      rating: 4.7,
    },
    {
      ...
      description:
        "Tempat persinggahan kebutuhan mahasiswa tempat hari dan persinggahan jangka apa saja seperti kopi dan lain lain",
      image: "/AI.jpg",
      tags: ["Asrama", "Internasional", "Penginapan"],
      buttonColor: "blue",
      location: "Kampus IPB",
      hours: "24 Jam",
      rating: 4.6,
    ...
    },
    {
      ...
      description: "Tempat untuk mencuci kendaraan pribadi seperti motor dan mobil",
      image: "/carewash.jpeg",
      tags: ["Cuci Mobil", "Layanan", "Kendaraan"],
      buttonColor: "orange",
      location: "Kampus IPB",
      hours: "08:00-17:00",
      rating: 4.5,
